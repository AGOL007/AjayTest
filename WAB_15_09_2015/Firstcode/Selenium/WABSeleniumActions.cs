...
namespace WebAppCommonSeleniumActions
{
    public static class WABSeleniumActions
    {
        ...
        public static void WebAppBuilderTitleClick(IWebDriver driver)
        {
            IWebElement arcGIS = driver.FindElement(By.ClassName("logo-title"));
            arcGIS.Click();
        }
        ...
        #region ContinuationOfScript

        public static void ContinueScriptWithConfigEditing()
        {
