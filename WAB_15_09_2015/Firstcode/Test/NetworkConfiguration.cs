...
namespace WebAppTest
{
    ...
    public class NetworkConfiguration : WABTestBase
    {
        ...
        [DataSource("System.Data.OleDb", "Provider=Microsoft.ACE.OLEDB.12.0;Data Source= \\\\CSSLESXI16-VM29\\Users\\sagarkul\\Desktop\\WAB\\DataSource.xlsx; Persist Security Info=False;Extended Properties='Excel 12.0 Xml;HDR=YES'", "WAB$", DataAccessMethod.Sequential), TestMethod()]
        ...
        public void WAB_NetworkConfiguration()
        {
            ...
            if (Convert.ToBoolean(context.DataRow["flag"].ToString()))
            {
            ...
            {
                // WABSeleniumActions.WebAppBuilderTitleClick(driver);

                //Click on Edit app
                WABSeleniumActions.EditWebApplication(driver);
                ...
                WABSeleniumActions.ClickOnEditIconNetworkTrace(driver);
            }
         ...
         //   WabDataSource.DataSource(context, webData);            
            ...
            {               
                ...
                string configJsonUrl = "http://csslesxi16-vm29.cybertech.com:3344/webappbuilder/apps/" + applicationNumber + "/configs/NetworkTrace/config_NetworkTrace.json";
          ...
          //  bool checkValidType = ValidateResult.AssertForAttributesWidget(typeActual, typeExpected);
            ...
            if (true && checkOverViewAttributesBoolean && checkOverViewAttributesFieldMap)
            {
